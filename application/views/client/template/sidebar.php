			...
			<div id="popular-tab">
				<ul>
					<li><a href="#"><img alt=""
						...
						<h3>
							<a href="#">Dictum ipsum vel laoreet. Sed convallis quam ut
								elit</a>
						</h3>
						<div class="post-date">March 25, 2012</div></li>
					<li><a href="#"><img alt=""
							src="http://placehold.it/60x60"></a>
						<h3>
							<a href="#">Dictum ipsum vel laoreet. Sed convallis quam ut
						...
						<div class="post-date">March 22, 2012</div></li>
					<li><a href="#"><img alt=""
							src="http://placehold.it/60x60"></a>
						<h3>
							<a href="#">Dictum ipsum vel laoreet. Sed convallis quam ut
						...
						<div class="post-date">March 05, 2012</div></li>
					<li><a href="#"><img alt=""
							src="http://placehold.it/60x60"></a>
						<h3>
							<a href="#">Dictum ipsum vel laoreet. Sed convallis quam ut
			...
			<div id="comments-tab">
				<ul>
					<li><a href="#"><img alt=""
						...
						<div class="author-comment">Nice theme, indeed :)</div></li>
					<li><a href="#"><img alt=""
							src="http://placehold.it/60x60"></a>
						<h3>
							<a href="#">faton says:</a>
						</h3>
						<div class="author-comment">very nice post!</div></li>
					<li><a href="#"><img alt=""
							src="http://placehold.it/60x60"></a>
						<h3>
							<a href="#">sami says:</a>
						</h3>
						<div class="author-comment">Nice theme I’m gonna use it on
							my next site. I loved the layout and ...</div></li>
					<li><a href="#"><img alt=""
							src="http://placehold.it/60x60"></a>
						<h3>
							<a href="#">sami says:</a>
