        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?php echo base_url() . 'assets/upload/images/avatars/' . $this->session->userdata('cur_user')['avatar']; ?>" class="user-image" alt="User Image" />
                        <span class="hidden-xs"><?php echo $this->session->userdata('cur_user')['fullName']; ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            ...
                            <p>
                                <?php echo $this->session->userdata('cur_user')['fullName']; ?> - Web Developer
